...
[![x-cmd/install — models Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/models.svg?lang=zh)](https://x-cmd.com/install/models)
...
合计: **110,629** 行代码（覆盖前 5 种语言、共 **109** 个文件）。
...
- **上游仓库**: <https://github.com/arimxyer/models>
- **官网**: <https://reyamira.github.io/models/>
- **许可证**: MIT
...
- **Star**: 510 · **Fork**: 20 · **开放 issue**: 7 · **贡献者**: 4

## 累计统计

- **发布数**: 46 · **已合并 PR**: 38 · **开放 PR**: 0 · **已关闭 issue**: 7 · **开放 issue**: 0 · **提交数**: 7768
...
| 360d | 2025-09-29 | 46 | 0 | 0 | 0 | 0 | 0 |
| last720d | 2024-10-04 | 46 | 0 | 0 | 0 | 0 | 0 |
...
models 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `models` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/models.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:35:22Z._
